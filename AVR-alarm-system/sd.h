...
#define SPI0_PORT								PORTA // SPI PORT
#define SPI0_DDR								DDRA  // SPI DDR
#define SPI0_PINS								PINA  // Holds the state of each pin on port where SPI pins are

#define SPI0_MOSI_PIN							PA4   // SDA pin
#define SPI0_SCK_PIN							PA1   // SCK pin

// SPI Chip Select pin
#define CARD_CS_DDR								DDRA
#define CARD_CS_PORT							PORTA
#define CARD_CS_PIN								PA6

// Card detect pin for card sockets with this feature (optional)
#define CARD_DETECT_DDR							DDRA
#define CARD_DETECT_PORT						PORTA
#define CARD_DETECT_PIN							PB0
#define CARD_DETECT_PINS						PINA
